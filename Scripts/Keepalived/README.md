...
Если роль БД primary, то она будет доступна по VIP1, если роль изменилась на standby, то БД будет доступна по VIP2. Это дает возможность ничего не менять на стороне клиента в случае смены ролей БД. \
