...
-- Практическая часть собеседования включает в себя написание sql запросов, для её выполнения 
-- необходимо зарегистрироваться на сервисе https://livesql.oracle.com
==================
    Вопросы
==================
-- Выпрос №4
