...
/*
  ...
  NOTES
    ...
    * v_alert_pct % заполнения ТП, с учетом автораширения, при котором срабатывает алерт (значение по умолчанию 85)
    * v_low_pct   % до которого необхоимо знизить заполнение ТП (значение по умолчанию 80)
