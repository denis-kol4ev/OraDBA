-- -----------------------------------------------------------------------------------
-- Описание: 
-- Процедура упрощает процесс подготовки файлов параметров для выгрузки партиций 
-- таблицы в дампы для долгосрочного хранения.
-- При вызове: 
-- 1. создает файл с параметрами для утилиты expdp в указанной директории  
-- 2. выводит команду для вызова expdp 
-- 3. атрибуты партииции и выгрузки логирует в таблицу expdp_log.
-- Администратор запускает выгрузку с помощью сформированной команды, 
-- после успешного завершения обновляет запись в таблице expdp_log, 
-- поле exported необходимо обновить на Y.
-- -----------------------------------------------------------------------------------
